...
IMPORTANT: Skills must be authored in English. User-facing answers may remain in original language per project rules.
...
- **Do not use literal `\n` inside labels** – Mermaid does not interpret such line breaks. Use `<br/>` for a line break.
